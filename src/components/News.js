...
export class News extends Component {
    ...
    async updateNews (){
        const url =`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=a0fc2065dd0d4ced969d2d7cae8df8c9&page=${this.state.page}&pageSize=${this.props.pageSize}`;
